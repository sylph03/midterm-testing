...
on
	primary (name = QuanLyQuayThuocdata, filename = 'D:\CSDLQuanLyQuayThuoc.mdf', size = 20MB, maxsize = 40MB, filegrowth = 20%)
log on
...
insert KhachHang values ('15055421',N'Nguyễn Tấn Đạt','17/8/1996','0904758375',N'Xi đa thời kì cuối')
insert KhachHang values ('15090902',N'Tùng Văn Sơn','27/6/1999','0908564664',N'Đau đầu rùa')
