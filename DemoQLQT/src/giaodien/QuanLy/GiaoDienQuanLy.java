...
public class GiaoDienQuanLy extends JFrame implements ActionListener {
	...
	public JTextField txtMaThuoc_DanhSach_DanhSachThuoc;
	public JTextField txtTenThuoc_DanhSach_DanhSachThuoc;
	private JTextField txtSoLuong_DanhSach_DanhSachThuoc;
	public JTextField txtGiaNhap_DanhSach_DanhSachThuoc;
	public JTextField txtGiaBan_DanhSach_DanhSachThuoc;
	public JTextField txtNCC_DanhSach_DanhSachThuoc;
	private JTextField txtTimkiem_DanhSach_DanhSachThuoc;
	private JTextField txtHSD_DanhSach_DanhSachThuoc;
	public JTextField txtLoai_DanhSach_DanhSachThuoc;
	...
	private JDateChooser dateChooserHSD_NhapHang_NhapDon, datechooserNgayLap_NhapHang,
			dateChoosertNgay_NhapHang_DanhSachDon;
	private JRadioButton rdbtnTimChinhXac_NhapHang_DanhSachDon, rdbtnTimTheoThang_NhapHang_DanhSachDon,
			rdbtnTimTheoNam_NhapHang_DanhSachDon;
	private JRadioButton rdbtnHienTatCa_NhapHang_DanhSachDon;
	private DefaultComboBoxModel<String> CBModelLoai_NhapHang_ThemThuoc, CBModelNCC_NhapHang_ThemThuoc,
			CBModelDonViTinh_NhapHang_ThemThuoc;
	...
	private JScrollPane scrollPaneDoanhthu_DoanhThuvaBaoCao, scrollPaneBaoCao_DoanhThuvaBaoCao,
			scrollPaneTinhTrangThuoc_TinhTrang;
	private JDateChooser datechooserNgay_DoanthuvaBaocao;
	private JRadioButton rdbtnHientatca_Doanhthu, rdbtnTimTheoNgay_Doanhthu, rdbtnTimtheoThang_Doanhthu,
			rdbtnTimTheoNam_Doanhthu;
	private JMonthChooser monthChooser_DoanhThuvaBaoCao;
	private JYearChooser yearChooser_DoanhThuvaBaoCao;
	public JPanel panelTimkiemDoanhthu;
	...
	public GiaoDienQuanLy() {
		...
		panelThongTinChiTietThuoc.setBorder(
		...
		btnTim_DanhSach_DanhSachThuoc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (vitri != -1) {
					...
					tableThongtinThuoc_DanhSach
							.scrollRectToVisible(tableThongtinThuoc_DanhSach.getCellRect(vitri, vitri, true));
					jsclist.setVisible(false);
				} else {
					jsclist.setVisible(false);
		...
		listTimKiem_DanhSach_DanhSachThuoc.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.getKeyCode() == KeyEvent.VK_ENTER) {
					txtTimkiem_DanhSach_DanhSachThuoc
							.setText(listTimKiem_DanhSach_DanhSachThuoc.getSelectedValue() + "");
		...
		jsclist.setBounds(551, 42, 186, 66);
		panelDanhSachThuoc.add(jsclist);
		panelDanhSachThuoc.add(scrollPane_ThongtinThuoc = new JScrollPane(
				tableThongtinThuoc_DanhSach = new JTable(tableModelThongTinthuoc)));
		...
		btnChinhSua_DanhSach_DanhSachThuoc
				.setIcon(new ImageIcon(GiaoDienQuanLy.class.getResource("/ser/package_editors (1).png")));
		...
		panelDanhSachNhanVien
				.add(scrollPaneNhanVien = new JScrollPane(tableThongTinNV = new JTable(tableModelThongTinNV)));
		...
		panelThongTinNV.setBorder(new TitledBorder(null, "Th\u00F4ng tin chi ti\u1EBFt", TitledBorder.LEADING,
			...
			public void keyReleased(KeyEvent arg0) {
				...
				try {
					...
					for (NhanVien nv : dsnv) {
						Object[] row = { nv.getMaNv(), nv.getHoTenNV(), nv.getNgaySinh(), nv.getGioiTinh(),
								nv.getDiaChi() };
		...
		btnSua_DanhSach_DanhSachNhanVien
				.setIcon(new ImageIcon(GiaoDienQuanLy.class.getResource("/ser/package_editors (1).png")));
		...
		tabbedPane.addTab("Doanh thu", null, scrollPaneDoanhthu_DoanhThuvaBaoCao = new JScrollPane(
				tableDoanhThu_Doanhthu_DoanhThuvaBaoCao = new JTable(tableModelDoanhThu_Doanhthu_DoanhThuvaBaoCao)),
				null);
		...
		panelThuChiDoanhthu_DoanhThuvaBaoCao.add(scrollPaneBaoCao_DoanhThuvaBaoCao = new JScrollPane(
				tableBaoCao_DoanhThuvaBaoCao = new JTable(tableModelBaoCao_Doanhthu_DoanhThuvaBaoCao)));
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (row != -1) {
					...
					double tongTien = Double
							.parseDouble(tableModelDoanhThu_Doanhthu_DoanhThuvaBaoCao.getValueAt(row, 4) + "");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (value == JFileChooser.APPROVE_OPTION) {
					...
					if (new File(file + "").exists() == false) {
						...
						JOptionPane.showMessageDialog(panelThuChiDoanhthu_DoanhThuvaBaoCao, "Tên này đã tồn tại",
		...
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.EAST, panelThonTinDonHang, -504, SpringLayout.EAST,
				panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.NORTH, panelThonTinDonHang, 0, SpringLayout.NORTH,
				panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.WEST, panelThonTinDonHang, 0, SpringLayout.WEST,
				panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.SOUTH, panelThonTinDonHang, 104, SpringLayout.NORTH,
				panel_NhapHang_NhapDon);
		panel_NhapHang_NhapDon.add(panelThonTinDonHang);
		panelThonTinDonHang.setBorder(
				new TitledBorder(null, "Thông tin hóa đơn nhập ", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panelNhapHang.add(scrollPane_TableThuocNhap = new JScrollPane(
				tableThuocNhap_NhapHang_NhapDon = new JTable(tableModelThuocNhap)));
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.SOUTH, scrollPane_TableThuocNhap, -5, SpringLayout.SOUTH,
				panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.EAST, scrollPane_TableThuocNhap, -10, SpringLayout.EAST,
				panel_NhapHang_NhapDon);
		panel_NhapHang_NhapDon.add(scrollPane_TableThuocNhap);

		panelNhapHang.add(scrollPane_TableDulieuThuoc = new JScrollPane(
				tableDulieuThuoc_NhapHang_NhapDon = new JTable(tableModelDulieuthuoc)));
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.NORTH, scrollPane_TableThuocNhap, 0, SpringLayout.NORTH,
				scrollPane_TableDulieuThuoc);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.WEST, scrollPane_TableDulieuThuoc, 6, SpringLayout.WEST,
				panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.SOUTH, scrollPane_TableDulieuThuoc, -5, SpringLayout.SOUTH,
				panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.EAST, scrollPane_TableDulieuThuoc, -507, SpringLayout.EAST,
				panel_NhapHang_NhapDon);
		panel_NhapHang_NhapDon.add(scrollPane_TableDulieuThuoc);

		btnThemVaoDon_NhapHang_NhapDon = new JButton("");
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.NORTH, btnThemVaoDon_NhapHang_NhapDon, 163,
				SpringLayout.NORTH, panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.WEST, btnThemVaoDon_NhapHang_NhapDon, 20,
				SpringLayout.EAST, scrollPane_TableDulieuThuoc);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.EAST, btnThemVaoDon_NhapHang_NhapDon, -15,
				SpringLayout.WEST, scrollPane_TableThuocNhap);
		...
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.NORTH, btnXoaKhoiDon_NhapHang_NhapDon, 224,
				SpringLayout.NORTH, panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.WEST, btnXoaKhoiDon_NhapHang_NhapDon, 20,
				SpringLayout.EAST, scrollPane_TableDulieuThuoc);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.EAST, btnXoaKhoiDon_NhapHang_NhapDon, -15,
				SpringLayout.WEST, scrollPane_TableThuocNhap);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.SOUTH, btnThemVaoDon_NhapHang_NhapDon, -11,
				SpringLayout.NORTH, btnXoaKhoiDon_NhapHang_NhapDon);
		...
		btnXoaKhoiDon_NhapHang_NhapDon.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (row != -1) {
					Object[] data = { tableThuocNhap_NhapHang_NhapDon.getValueAt(row, 0),
							tableThuocNhap_NhapHang_NhapDon.getValueAt(row, 1) };
		...
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.SOUTH, btnXoaKhoiDon_NhapHang_NhapDon, -80,
				SpringLayout.NORTH, btnHoanTat_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.WEST, scrollPane_TableThuocNhap, 6, SpringLayout.EAST,
				btnHoanTat_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.NORTH, btnHoanTat_NhapHang_NhapDon, 354,
				SpringLayout.NORTH, panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.WEST, btnHoanTat_NhapHang_NhapDon, 6, SpringLayout.EAST,
				scrollPane_TableDulieuThuoc);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.SOUTH, btnHoanTat_NhapHang_NhapDon, -10,
				SpringLayout.SOUTH, panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.EAST, btnHoanTat_NhapHang_NhapDon, -390, SpringLayout.EAST,
				panel_NhapHang_NhapDon);
		...
		panel_NhapHang_DanhSach.add(scrollPane_NhapHang_DanhSachDon = new JScrollPane(
				tableDanhSachDonHang_NhapHang_DanhSachDon = new JTable(tableModel_NhapHang_DanhSachDon)));
		scrollPane_NhapHang_DanhSachDon.setSize(234, 311);
		scrollPane_NhapHang_DanhSachDon.setLocation(12, 134);
		panel_NhapHang_DanhSach.add(scrollPane_NhapHang_ChiTietDon = new JScrollPane(
				tableChitietDon_NhapHang_DanhSachDon = new JTable(tableModel_NhapHang_ChitietDon)));
		...
		tableDanhSachDonHang_NhapHang_DanhSachDon.getSelectionModel()
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (rdbtnTimChinhXac_NhapHang_DanhSachDon.isSelected()) {
					for (HoaDonNhapHang hdn : ds.listHDN) {
						if (dateformat.format(dateChoosertNgay_NhapHang_DanhSachDon.getDate())
								.equals(hdn.getNgayNhap())) {
					...
					ArrayList<HoaDonNhapHang> ds = control
							.TimHDNHangTheoThang(monthChooser_NhapHang_DanhSachDon.getMonth() + 1);
					...
					ArrayList<HoaDonNhapHang> ds = control
							.TimHDNHangTheoNam(yearChooser_NhapHang_DanhSachDon.getYear());
					for (HoaDonNhapHang hd : ds) {
						Object[] row = { hd.getMaHDN(), hd.getNgayNhap(), hd.getTongGiaNhap() };
						tableModel_NhapHang_DanhSachDon.addRow(row);
						;
		...
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.NORTH, lblNewLabel_15, 6, SpringLayout.SOUTH,
				panelThonTinDonHang);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.WEST, lblNewLabel_15, 10, SpringLayout.WEST,
				panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.NORTH, scrollPane_TableDulieuThuoc, 6, SpringLayout.SOUTH,
				lblNewLabel_15);
		panel_NhapHang_NhapDon.add(lblNewLabel_15);

		JLabel lblNewLabel_16 = new JLabel("Thuốc nhập");
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.NORTH, lblNewLabel_16, 0, SpringLayout.NORTH,
				lblNewLabel_15);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.WEST, lblNewLabel_16, 314, SpringLayout.EAST,
				lblNewLabel_15);
		panel_NhapHang_NhapDon.add(lblNewLabel_16);

		JPanel panel_1 = new JPanel();
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.NORTH, panel_1, 0, SpringLayout.NORTH,
				panelThonTinDonHang);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.WEST, panel_1, 133, SpringLayout.EAST,
				panelThonTinDonHang);
		...
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.SOUTH, panel_1, 104, SpringLayout.NORTH,
				panel_NhapHang_NhapDon);
		sl_panel_NhapHang_NhapDon.putConstraint(SpringLayout.EAST, panel_1, -10, SpringLayout.EAST,
				panel_NhapHang_NhapDon);
			...
			public void focusLost(FocusEvent arg0) {
				if (!txtmathuoc_NhapHang_Themthuoc.getText().trim().equals("")) {
					if (ds.TimThuocTheoMa(txtmathuoc_NhapHang_Themthuoc.getText()) == null) {
						lbkiemtrama_Themthuoc
								.setIcon(new ImageIcon(GiaoDienQuanLy.class.getResource("/ser/check.png")));
				...
				if (!txtGiaNhap_NhapHang_Themthuoc.getText().trim().equals("")) {
					try {
						...
						if (i < 0) {
							...
							lbkiemtraGiaNhap_Themthuoc
									.setIcon(new ImageIcon(GiaoDienQuanLy.class.getResource("/ser/stop.png")));
		...
		panelTinhTrang.add(scrollPaneTinhTrangThuoc_TinhTrang = new JScrollPane(
				tableTinhTrangThuoc_TinhTrang = new JTable(tableModelTinhTrangThuoc_TinhTrang)));
		...
		lblNewLabel_31
				.setToolTipText("Tìm doanh thu cả nv theo thời gian chỉ định . Để trống để tìm hết các nhân viên");
		...
		TongDoanhThu_DoanhThu_DoanhThu
				.setText(control.tongDoanhThu(tableModelDoanhThu_Doanhthu_DoanhThuvaBaoCao, 4) + "");
		...
		if (e.getSource() == btnThemVaoDon_NhapHang_NhapDon) {
			...
			if (row != -1) {
				if (!txtSoLuong_NhapHang_NhapDon.getText().equals("")) {
					...
					if (soLuong > 0) {
						Object[] data = { tableDulieuThuoc_NhapHang_NhapDon.getValueAt(row, 0),
								tableDulieuThuoc_NhapHang_NhapDon.getValueAt(row, 1),
			...
			try {
				if (!control.kiemTraDuLieuSo(txtGiaBan_DanhSach_DanhSachThuoc.getText())
						|| !control.kiemTraDuLieuSo(txtGiaNhap_DanhSach_DanhSachThuoc.getText())) {
					JOptionPane.showMessageDialog(panelDanhSach, "Giá nhập, Giá Bán phải là số");
				} else if (Double.parseDouble(txtGiaBan_DanhSach_DanhSachThuoc.getText()) < 0
						|| Double.parseDouble(txtGiaNhap_DanhSach_DanhSachThuoc.getText()) < 0) {
					JOptionPane.showMessageDialog(panelDanhSach, "Giá nhập, Giá Bán không được âm");
				} else {
					int selection = JOptionPane.showConfirmDialog(panelDanhSach, "Bạn chắc chắn sửa ?", "Sửa dữ liệu",
			...
			if (row != -1) {
				...
				int selection = JOptionPane.showConfirmDialog(panelDanhSach, "Bạn chắc chắn xóa ?", "Xóa",
				...
				try {
					...
					if (selection == JOptionPane.YES_OPTION) {
						if (control.xoaThuocTrongSQL(maThuocXoa)) {
							...
							JOptionPane.showMessageDialog(panelDanhSach,
									"Không được xóa! Thuốc này đã nằm trong danh sách bán hàng");
					}
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
			...
			try {
				if (Double.parseDouble(txtGiaNhap_NhapHang_Themthuoc.getText()) > 0
						&& Double.parseDouble(txtGiaBan_NhapHang_Themthuoc.getText()) > 0) {
					ThongTinThuoc thuoc = new ThongTinThuoc();
			...
			for (HoaDonBanHang hd : hoadon) {
				if (mnv.equals("")) {
					Object[] row = { hd.getMaNVLap(), ds.TimNVTheoMa(hd.getMaNVLap()).getHoTenNV(), hd.getMaHD(),
			...
			try {
				if (control.kiemTraDuLieuSo(CMND) && control.kiemTraDuLieuSo(sdt)) {
					if (Long.parseLong(CMND) > 0 && Long.parseLong(sdt) > 0
							&& control.kiemTraCMND(CMND) && control.kiemTraSDT(sdt)) {
						try {
							int selection = JOptionPane.showConfirmDialog(panelDanhSach, "Bạn có muốn lưu", "Chú ý",
									JOptionPane.YES_NO_CANCEL_OPTION);
							if (selection == JOptionPane.YES_OPTION) {
						...
						if (!control.kiemTraCMND(CMND))
							JOptionPane.showMessageDialog(panelDanhSach, "CMND phải bao gồm 9 hoặc 12 CHỮ SỐ!!! ");
	...
	void duaDuLieuTuListVaoTable() {
		...
		for (HoaDonBanHang hdb : ds.listHDB) {
			Object[] row = { hdb.getMaNVLap(), ds.TimNVTheoMa(hdb.getMaNVLap()).getHoTenNV(), hdb.getMaHD(),
					hdb.getNgayLap(), hdb.getTongTien() };
			tableModelDoanhThu_Doanhthu_DoanhThuvaBaoCao.addRow(row);
		}
		for (CTHoaDonBan ctHDB : ds.listThuocBan) {
			...
			try {
				if ((control.timHDBtheoMa(maHD).getNgayLap()).equals(control.layNgayHeThong())) {
					Object[] row = { ctHDB.getMaThuoc(), ctHDB.getTenThuoc(), ctHDB.getSoLuong(),
							ds.TimThuocTheoMa(ctHDB.getMaThuoc()).getDonViTinh(),
							(control.tinhTienLoi(ctHDB.getMaThuoc(), ctHDB.getSoLuong())) + "" };
					tableModelBaoCao_Doanhthu_DoanhThuvaBaoCao.addRow(row);
				}
			} catch (SQLException e) {
				// TODO Auto-generated catch block
				JOptionPane.showMessageDialog(panelThuChiDoanhthu_DoanhThuvaBaoCao,
						"Chưa có thuốc nào được bán trong hôm nay!");
			}
		}
	}
	...
	public void FillFormThuoc(int row) {
		if (row != -1) {
			...
			txtSoLuong_DanhSach_DanhSachThuoc.setText(
					ds.TimThuocTheoMa(tableThongtinThuoc_DanhSach.getValueAt(row, 0).toString()).getSoLuong() + "");
			txtGiaBan_DanhSach_DanhSachThuoc
					.setText(ds.TimThuocTheoMa(tableThongtinThuoc_DanhSach.getValueAt(row, 0) + "").getGiaBan() + "");
			txtGiaNhap_DanhSach_DanhSachThuoc
					.setText(ds.TimThuocTheoMa(tableThongtinThuoc_DanhSach.getValueAt(row, 0) + "").getGiaNhap() + "");
			txtHSD_DanhSach_DanhSachThuoc
					.setText(ds.TimThuocTheoMa(tableThongtinThuoc_DanhSach.getValueAt(row, 0) + "").getHsd() + "");
			txtDonViTinh_DanhSach_DanhSachThuoc.setText(
					ds.TimThuocTheoMa(tableThongtinThuoc_DanhSach.getValueAt(row, 0) + "").getDonViTinh() + "");
	...
	public void TaiTinhTrangThuoc() {
		...
		for (ThongTinThuoc thuoc : ds.listThuoc) {
			...
			if (i > 0) {
				Object[] row = { thuoc.getMaThuoc(), thuoc.getTenThuoc(), thuoc.getLoai(), thuoc.getNcc(),
						thuoc.getHsd(), thuoc.getSoLuong(), thuoc.getDonViTinh(), tinhtrang };
